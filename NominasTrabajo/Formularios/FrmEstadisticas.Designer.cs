...
namespace NominasTrabajo.Formularios
{
	partial class FrmEstadisticas
	{
		...
		private void InitializeComponent()
		{
			...
			this.guna2Panel1.Controls.Add(this.lblInformacion);
			this.guna2Panel1.Controls.Add(this.label1);
			this.guna2Panel1.Location = new System.Drawing.Point(15, 31);
			...
			this.guna2Panel3.Controls.Add(this.lblNomina);
			...
			this.guna2Panel5.Controls.Add(this.lblDespedidos);
			...
			this.guna2Elipse2.TargetControl = this.gunaChart1;
			// 
			// guna2Elipse3
			// 
		...
		private System.Windows.Forms.Label lblDespedidos;
